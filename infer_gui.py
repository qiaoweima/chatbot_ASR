...
class SpeechRecognitionApp:
    def __init__(self, window: Tk, args):
        ...
        self.short_button = Button(self.window, text="short_audio", width=20, command=self.predict_audio_thread)
        ...
        self.long_button = Button(self.window, text="long_audio", width=20, command=self.predict_long_audio_thread)
        ...
        self.record_button = Button(self.window, text="recording", width=20, command=self.record_audio_thread)
